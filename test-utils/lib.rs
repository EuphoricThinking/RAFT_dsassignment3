...
pub fn extract_messages<T>(rx: &mut tokio::sync::mpsc::UnboundedReceiver<T>) -> Vec<T> {
...
pub struct RaftSpy {
    ...
    pub tx: tokio::sync::mpsc::UnboundedSender<RaftMessage>,
}
...
impl RaftSpy {
    pub async fn new(
        ...
        tx: tokio::sync::mpsc::UnboundedSender<RaftMessage>,
    ) -> ModuleRef<Self> {
